...
const OrgRequestsPage = () => {
  ...
  const presentationsQuery = useAggregatePresentationQuery({
    skip: true,
  })
  ...
  async function fetchPresentations() {
    try {
      const res = await presentationsQuery.refetch({
        where: {
          organizationId: { equals: (orgId as string) || undefined },
        },
      })
      setPresentations(res.data?.aggregatePresentation?._count?.id || 0)
    } catch {
      setPresentations(0)
    }
  }
              ...
              <Grid.Col span={2}>
                ...
                >
                  <Stack align='center' pt={4} mb={4} spacing={3}>
                    ...
                    <Badge variant='light' color='indigo' mt={2}>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      router.push(
                        `/dashboard/organizations/${orgData.organization?.id}/presentations`
                      )
                    }
                  >
