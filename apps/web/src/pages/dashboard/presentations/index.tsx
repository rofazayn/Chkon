        ...
        <Box>
          <Group spacing={8} align='center'>
            <Text weight='bold' size='lg'>
              My verifiable presentations
            </Text>
          </Group>

          <Text color='dimmed'>
            This page shows you presentations that you have presented to other
            organizations, the table below has all of them
          </Text>
        </Box>
...
export default DashboardUserPresentations
